...
public class ChemicalReactorRecipe extends AbstractRecipe<RecipeInventoryWrapper> implements RecipeInteraction {
    ...
    public static class Serializer implements RecipeSerializer<ChemicalReactorRecipe> {
        ...
        @Override
        public ChemicalReactorRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        @Override
        public @Nullable ChemicalReactorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
