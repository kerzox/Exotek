...
public class CentrifugeRecipe extends AbstractRecipe<RecipeInventoryWrapper> implements RecipeInteraction {
    ...
    public static class Serializer implements RecipeSerializer<CentrifugeRecipe> {
        ...
        @Override
        public @Nullable CentrifugeRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
