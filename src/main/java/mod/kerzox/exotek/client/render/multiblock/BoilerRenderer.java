...
public class BoilerRenderer implements BlockEntityRenderer<BoilerEntity> {
    ...
    public static final ResourceLocation BOILER = new ResourceLocation(Exotek.MODID, "multiblock/boiler");

    public BoilerRenderer(BlockEntityRendererProvider.Context pContext) {

    }

    @Override
    public void render(BoilerEntity entity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
        BakedModel model = Minecraft.getInstance().getModelManager().getModel(BOILER);
