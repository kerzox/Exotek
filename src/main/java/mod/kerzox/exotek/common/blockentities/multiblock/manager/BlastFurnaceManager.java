...
public class BlastFurnaceManager extends AbstractMultiblockManager {

    private ItemStackInventory inventory = new ItemStackInventory(3, 1);
    ...
    public boolean onPlayerClick(Level pLevel, Player pPlayer, BlockPos pPos, InteractionHand pHand, BlockHitResult pHit) {
        if (!pLevel.isClientSide) if (getManagingBlockEntity() != null) return this.getManagingBlockEntity().getSecond().onPlayerClick(pLevel, pPlayer, pPos, pHand, pHit);
        return false;
    }
