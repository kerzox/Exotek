...
public class ConveyorBeltRampEntity extends BasicBlockEntity implements IServerTickable, IClientTickable, IConveyorBeltCollision {
...
//                    }
//                }
                if (level.getBlockEntity(pos.relative(getBeltDirection())) instanceof ConveyorBeltRampEntity belt) {
                    stop = belt.stop;
                } else {
