...
public class BlastFurnaceRecipe extends AbstractRecipe<RecipeInventoryWrapper> implements RecipeInteraction {
    ...
    public BlastFurnaceRecipe(RecipeType<?> type, ResourceLocation id, String group, ItemStack result, Ingredient[] ingredients,
    ...
    public boolean matches(RecipeInventoryWrapper pContainer, Level pLevel) {
        return getIngredients().get(0).test(pContainer.getItem(0)) && getIngredients().get(1).test(pContainer.getItem(1));
    }
    ...
    public static class Serializer implements RecipeSerializer<BlastFurnaceRecipe> {
        ...
        public BlastFurnaceRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BlastFurnaceRecipe(ExotekRegistry.BLAST_FURNACE_RECIPE.get(), id, group, resultStack, ingredient, fluidIngredients, duration);
        ...
        public @Nullable BlastFurnaceRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
           ...
           int duration = buf.readVarInt();
            return new BlastFurnaceRecipe(ExotekRegistry.BLAST_FURNACE_RECIPE.get(), id, group, resultStack, ingredients, fluidIngredients, duration);
        }
    ...
    public static class DatagenBuilder {
        ...
        public static DatagenBuilder addRecipe(ResourceLocation name, ItemStack result, Ingredient[] ingredients, int duration) {
            return new DatagenBuilder(name, result, ingredients, new FluidIngredient[] { FluidIngredient.of(FluidStack.EMPTY) }, duration, ExotekRegistry.BLAST_FURNACE_RECIPE_SERIALIZER.get());
        }
